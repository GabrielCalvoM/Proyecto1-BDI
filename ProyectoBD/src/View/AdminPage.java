...
public class AdminPage extends javax.swing.JPanel {
    ...
    private void RemoveCountryBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveCountryBtnActionPerformed
        try{
            ...
            mainFrame.showError("Error al eliminar el país.");
        }
        try {
            EditCountries_CountryList.setModel(mainFrame.buildListModel(Cursors.getCountries()));
        }
    ...
    private void InsertArtist_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertArtist_ButtonActionPerformed
        addArtist_nameTxt.setText("");
        addArtist_lastnameTxt.setText("");
        addArtist_bioTxt.setText("");
        addArtist_triviaTxt.setText("");
        try {
            DefaultComboBoxModel gendersModel = mainFrame.buildComboModel(Cursors.getGenders());
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        if (lastName.length() > 20) {
            mainFrame.showError("Apellido muy largo. (>20)");
            return;
        }
        if (bio.length() > 3000) {
            mainFrame.showError("Biografía muy larga. (>3000)");
            return;
        }
        if (trivia.length() > 1000) {
            mainFrame.showError("Dato muy largo. (>1000)");
            return;
        }
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        seasonsCount = 1;
        generateSeasonModel();
        addSeries_title.setText("");
        addSeries_trailer.setText("");
        addSeries_synopsis.setText("");
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        ...
        addMovie_trailer.setText("");
        addMovie_duration.setText("");
        addMovie_synopsis.setText("");
        CardLayout card = (CardLayout) EditProducts.getLayout();
    ...
    private void jButton36ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton36ActionPerformed
        ...
        float price;
        if (title.length() > 30){
            mainFrame.showError("Título muy largo. (>30)");
            return;
        }
        if (premier > 2024 || premier < 1900){
            mainFrame.showError("Año de estreno inválido");
            return;
        }
        if (trailer.length() > 100){
            mainFrame.showError("Link al tráiler muy largo. (>100)");
            return;
        } 
        if (synopsis.length() > 300){
            mainFrame.showError("Sinópsis muy larga. (>300)");
            return;
        }          
        try {
            duration = Integer.parseInt(addMovie_duration.getText());
    ...
    private void UpdateDirector_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateDirector_ButtonActionPerformed
        try {
            ...
            DefaultComboBoxModel typesModel = mainFrame.buildComboModel(Cursors.getArtistTypes());
            editArtist_typeCombo.setModel(typesModel);
            editArtist_typeCombo.setSelectedIndex(1);
            editArtist_nameTxt.setText(person.getFirst_Name());
            editArtist_lastnameTxt.setText(person.getLast_Name());
    ...
    private void UpdateWriter_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateWriter_ButtonActionPerformed
        try {
            ...
            DefaultComboBoxModel typesModel = mainFrame.buildComboModel(Cursors.getArtistTypes());
            editArtist_typeCombo.setModel(typesModel);
            editArtist_typeCombo.setSelectedIndex(2);
            editArtist_nameTxt.setText(person.getFirst_Name());
            editArtist_lastnameTxt.setText(person.getLast_Name());
            DateFormat format = new SimpleDateFormat("dd-MMM-yy");
            editArtist_date.setDate( format.parse((person.getBirthDate())));
